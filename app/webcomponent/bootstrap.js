...
import registerComponent from '@jupyterlite/webcomponent';
...
import { main } from './webcomponent.js';
...
//  let main = (await import('./webcomponent.js')).main;
//  void main();
//  console.log("BOO");
  let main = (await import('@jupyterlite/webcomponent')).registerComponent;
  void main();
  console.log("BOO");
